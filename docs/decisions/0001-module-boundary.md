# ADR-001: Keep observability-otel as an Independent Gnalloy Module
...
`observability-otel` is published as `gnalloy.org/observability-otel` and owns this responsibility: OpenTelemetry adapter for Gnalloy observability metrics.
