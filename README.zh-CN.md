...
- 导入路径：`gnalloy.org/observability-otel`
- 仓库：`github.com/gnalloy/observability-otel`
- 默认分支：`dev`
- 预览安装：`go get gnalloy.org/observability-otel@dev`
- 许可证：Apache-2.0
...
本仓库负责：Gnalloy observability metrics 的 OpenTelemetry 适配器。
